 ...
 */
#ifndef _CONNECTIVITYBLUETOOTHWINDOWSMOBILEWIDCOMM_H_
#define _CONNECTIVITYBLUETOOTHWINDOWSMOBILEWIDCOMM_H_
...
#endif /* _CONNECTIVITYBLUETOOTHWINDOWSMOBILEWIDCOMM_H_ */
