...
/*
	It is weird that Microsoft has a time.h header file in the core libraries but no implementation.
	We have to provide the implementation here instead.
*/


/*
	The following code is from the WCECompat library, GPL license.
